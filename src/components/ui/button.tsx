...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground hover:bg-primary-700 shadow-sm active:scale-[0.98]',
        destructive:
        ...
        primary:
          'bg-[#1B4FDE] text-white hover:bg-[#1640C4] shadow-sm active:scale-[0.98]',
        'primary-outline':
          'border-2 border-[#1B4FDE] text-[#1B4FDE] bg-transparent hover:bg-[#EFF4FF] active:scale-[0.98]',
        white:
          'bg-white text-[#1B4FDE] hover:bg-gray-50 shadow-sm active:scale-[0.98]',
        'white-outline':
